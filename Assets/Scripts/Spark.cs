...
public class Spark
{
	...
	public void init(Material material)
	{
		...
		material_.SetColor("_Colors2", new Color(0.2f, 1f, 0.6f, 1f)); // Bullet
		material_.SetColor("_Colors3", new Color(0.2f, 1f, 0.6f, 0f)); // BulletA
		material_.SetColor("_Colors4", new Color(1f, 0.7f, 0.25f, 1f)); // EnemyBullet
		material_.SetColor("_Colors5", new Color(1f, 0.7f, 0.25f, 0f)); // EnemyBulletA
#else
